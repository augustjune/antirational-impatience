...
object Utils {
  def main(args: Array[String]): Unit = {
    ...
    val bench = new Benchmark {
      def sources: List[String] = List("P:\\Projects\\Studia\\VI_Semestr\\Sztuczna Inteligencja i inzyneria wiedzy\\Lab\\src\\test\\resources\\test_matrix_16.txt",
      ...
      def engines: List[LoggedGeneticEngine] = List(
